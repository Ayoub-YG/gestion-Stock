  ...
  return (
    <div className="">
      ...
      <div className="flex justify-end mr-4 " >
        <button className="text-white bg-black px-3 py-2  rounded-md" onClick={handelOpen} >Ajouter un Article</button>
      </div>
      ...
      >
        <div className="py-8 px-16 ">
          ...
          <form className="flex flex-col justify-center gap-7">
            <input className="border-none px-2 w-64  py-2 bg-gray-200 text-black rounded-md" type="text" placeholder="code" />
            <input className="border-none px-2 w-64 py-2 bg-gray-200 text-black rounded-md"  type="text" placeholder="marque" />
            <input className="border-none px-2 w-64 py-2 bg-gray-200 text-black rounded-md" type="text" placeholder="quantiter" />
            <input className="border-none px-2 w-64 py-2 bg-gray-200 text-black rounded-md" type="text" placeholder="code fournisseur" />
            <input className="border-none px-2 w-64 py-2 bg-gray-200 text-black rounded-md" type="text" placeholder="prix" />
            <div className="flex justify-end ">
                <button onClick={handelData} className="bg-black text-white rounded-lg px-5 py-2">valider</button>
            </div>
          </form>
        </div>
      </Dialog>
