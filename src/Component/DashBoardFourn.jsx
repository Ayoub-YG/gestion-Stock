  ...
  return (
    <div className="">
      ...
      <div className="flex justify-end mr-4 " >
        <button className="text-white bg-black px-3 py-2  rounded-md" onClick={handelOpen} >Ajouter un fournisseur</button>
      </div>
      ...
      >
        <div className="py-8 px-16 ">
          ...
          <form className="flex flex-col justify-center gap-7">
            ...
            <input className="border-none px-2 w-64 py-2 bg-gray-200 text-black rounded-md"  type="text" placeholder="Nom" />
            <input className="border-none px-2 w-64 py-2 bg-gray-200 text-black rounded-md" type="text" placeholder="Phone" />
